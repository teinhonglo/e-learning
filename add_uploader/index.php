...
$(document).ready( function() {
	...
	$('#example').dataTable( {
		...
		"aoColumns": [ { "bSortable": true }, { "bSortable": true }, { "bSortable": true },{ "bSortable": true }, { "bSortable": true },{ "bSortable": false, "sWidth": 20 } ], 
...
<?
	if($memberType >= 3)
	{
		echo "<li  class=\"current_page_item\"><a href=\"../add_uploader\" accesskey=\"5\" title=\"新增上傳者\">新增上傳者</a></li>";
	}
?>
...
<div id="wrapper">
	<div id="featured-wrapper">
		<div class="extra2 container">
			<br>
			<center><label id="my_sub_module_title">Uploader List</label></center>
					<br>
					<br>
					<div style="margin-left:auto; margin-right:auto; white-space:nowrap;">
						<table cellpadding="0" cellspacing="0" border="0" id="example" width="100%" >
							<thead>
								<tr>
									<th style="font-size:14pt;">名稱</th>
									<th style="font-size:14pt;">信箱</th>
									<th style="font-size:14pt;">部門名字</th>
									<th style="font-size:14pt;">BU</th>
									<th style="font-size:14pt;">註冊時間</th>
									<th align="right">
										<!--control page-->
					<?
										if($memberType >= 3){
											echo "<a href=\"Add\" class=\"various\"><img class=\"TipRight\" src=\"../../images/add-icon.gif\" style=\"border:none;\" title=\"<font style='font-size:13pt;'>Add Video</font>\"></a>";
										} else{
											echo "<center><img class=\"TipRight\" src=\"../../images/add-icon-disable.png\" style=\"border:none;\" title=\"Edit $FormName (Don't have permission)<br>If need, Please contact the Confirm Member or Administrator.\"></center>";
										}
					?>
										<!--end-->
									</th>
							...
							<tfoot>
								<tr>
									<th style="font-size:14pt;">Name</th>
									<th style="font-size:14pt;">E-Mail</th>
									<th style="font-size:14pt;">Department Name</th>
									<th style="font-size:14pt;">BU</th>
									<th style="font-size:14pt;">Register Time</th>
									<th style="font-size:14pt;">Del</th>
								</tr>
							</tfoot>
						</table>
					<?PHP
