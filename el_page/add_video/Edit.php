...
<?PHP
	...
	// Check InfoID Parameter is exist.
	Check_InfoID_Parameter($ID);
...
<title>Meeting Minutes - KM</title>
...
$(document).ready( function() {
	...
	//Hide or Show Password Input text field.
...
<?PHP
	...
	$VideoName = $row[0];
?>
			<form name="EditForm" id="EditForm" method="post" action="Edit_Action" enctype="multipart/form-data">
				<input name="ID" id="ID" type="hidden" value="<?=$ID;?>" />
				<table align="center" width="680">
					<tr height="46">
							<th colspan="2" align="center"><label style="font-size:18pt;">修改 <?=$VideoName;?></label></th>
					</tr>
					<tr height="54">
						...
						<td bgcolor="#FFEEFF" style="padding:10px;"><input type="text" name="VideoName" id="VideoName" style="width:470px; height:30px;" value="<?=$VideoName;?>" Maxlength="30"/></td>
					</tr>
					<tr height="54">
...
?>
					...
					<tr height="54">
						...
						<td bgcolor="#FFEEFF" style="padding:10px;"><input type="checkbox" id="reset_password" name="reset_password" value="reset_password" title="清空密碼"/><input type="text" name="VideoPassword" id="VideoPassword" style="width:80%; height:30px;" placeholder="選取代表清空，空白代表不更動設定" Maxlength="20"/></td>
					</tr>
					<tr height="186">
						...
						<td align="left" bgcolor="#FFEEFF" style="padding:10px;">
							...
							<div id="select_all_people_list">
								<select name="Viewer[]" id="Viewer"  multiple="multiple">
<?PHP
				// Select Member List.
...
?>
					...
					<tr height="54">
						<td align="right" colspan="2" bgcolor="#FFEEFF" style="padding:10px;">
							<input class="my_button" type="submit" value="修改" style="width:86px; height:38px" />&nbsp;&nbsp;
