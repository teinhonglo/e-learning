...
$(document).ready( function() {
	...
	$('#example').dataTable( {
		...
		"aoColumns": [ { "bSortable": true }, { "bSortable": true }, { "bSortable": true }, { "bSortable": false, "sWidth": 40 } ], 
...
<?
	if($memberType >=2)
	{
		...
		echo "<li class=\"current_page_item\"><a href=\"#\" accesskey=\"2\" title=\"新增你的影片\">新增上傳影片</a></li>";
	}
?>
...
<div id="wrapper">
	<div id="featured-wrapper">
		<div class="extra2 container">
			<br>
			<center><label id="my_sub_module_title">新增上傳影片<? echo "(" . $_SESSION['s_EnglishName'] . ")" ?></label></center>
			<br>
			<br>
				...
				<table cellpadding="0" cellspacing="0" border="0" id="example" width="100%" >
					<thead>
						<tr>
							...
							<th style="font-size:14pt;">影片大小</th>
							<th style="font-size:14pt;">上傳時間</th>
							<th align="right">
								<!--control page-->
			<?
								if($memberType >= 2){
									echo "<a href=\"Add2\" class=\"various\"><img class=\"TipRight\" src=\"../../images/add-icon.gif\" style=\"border:none;\" title=\"<font style='font-size:13pt;'>Add Video</font>\"></a>";
								} else{
