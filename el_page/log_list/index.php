...
?>
				...
				<li class="current_page_item"><a href="#" accesskey="4" title="影片歷程記錄">我的觀看歷程記錄</a></li>
<?
	if($memberType >= 3)
	{
...
<div id="wrapper">
	<div id="featured-wrapper">
		<div class="extra2 container">
			<br>
			<center><label id="my_sub_module_title">您的觀看歷程記錄<? echo "(" . $_SESSION['s_EnglishName'] . ")"; ?></label></center>
			<br>
			<br>
				...
				<table cellpadding="0" cellspacing="0" border="0" id="example" width="100%" >
					<thead>
						<tr>
							...
							<th style="font-size:14pt;">觀看時間</th>
						</tr>
					</thead>
					<tbody>
						<tr height="60">
